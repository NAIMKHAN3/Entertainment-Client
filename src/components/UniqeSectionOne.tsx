...
const UniqeSectionOne = () => {
    return (
        ...
        <div className="flex flex-col-reverse lg:flex-row px-5 md:px-20 pb-0">
          <div className="md:w-1/2 w-full px-2 z-10 my-4 lg:my-auto ">
            <h2 className="text-xl md:text-3xl leading-tight mb-8 ">
              Watch Thousands of Shows and Movies Anytime, Anywhere
            </h2>
            <div className="flex justify-center lg:justify-start">
              <Link href='/cinema'><button className="uppercase rounded-md bg-[#00246a] text-white px-3 py-2 lg:px-4 lg:py-4 shadow text-sm z-30 hover:shadow-lg">
