    ...
    return (
       <div>
        <h1 className='text-center font-semibold text-xl mt-5'>Blog List</h1>
         <div className='grid grid-cols-2 gap-3 max-w-6xl mx-auto my-5'>
            {
                data?.data?.map((blog: any) => <div key={blog.id} className='flex border p-3 rounded-md'>
                    <img className='w-36 ' src={blog.image} alt="" />
                    <div className='p-3'>
